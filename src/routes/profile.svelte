...
<div use:getProfiles>
	{#if full_name}
		<div
			class="block mt-4 max-w-md  md:max-w-2xl  min-w-0 break-words mx-auto bg-gray-50 shadow-lg rounded-xl "
		>
			<div class="px-6">
					...
					<div class="flex flex-wrap px-4">
						<div class="w-full leading-relaxed text-slate-900 mb-4 ">
							...
							<textarea
								...
								style="resize:none"
								value={message}
								class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-50  dark:bg-gray-50  dark:placeholder-gray-50 dark:text-black "
							/>
						</div>
						<div class="w-full px-4 text-center">
							<a
								href="./"
								on:click={connect}
								class="font-normal text-slate-700 hover:text-slate-400">Connect</a
							>
							/
							<a href="./" on:click={next} class="font-normal text-slate-700 hover:text-slate-400"
								>Next</a
							>
						</div>
					</div>
